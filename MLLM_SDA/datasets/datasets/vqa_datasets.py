...
from MLLM_SDA.datasets.datasets.base_dataset import BaseDataset
...
class VizWizEvalData(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        question = f"[vqa] The question is '{question}' Based on the image, answer the question with detail."
